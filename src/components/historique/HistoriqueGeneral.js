            ...
            devis.map(row=>{
              return(
                ...
                <TableRow>
                  ...
                  <TableCell  align="center"><Button variant="outlined" color="error" onClick={()=>deleteDevis(row._id)}>Supprimer</Button><Button variant="contained" color="success" onClick={()=>handleOpen(row)}>PDF</Button></TableCell>
                </TableRow>
